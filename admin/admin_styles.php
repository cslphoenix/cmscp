	...
	switch( $mode )
	{
		case "addnew":
			...
			else
			{
				...
				if( $dir = @opendir($root_path. "templates/") )
				{
					...
					{
						if( !is_file(phpbb_realpath($root_path . 'templates/' .$sub_dir)) && !is_link(phpbb_realpath($root_path . 'templates/' .$sub_dir)) && $sub_dir != "." && $sub_dir != ".." && $sub_dir != "CVS" )
						{
							if( @file_exists(@phpbb_realpath($root_path. "templates/" . $sub_dir . "/theme_info.cfg")) )
							{
					...
					$template->set_filenames(array(
						"body" => "./../admin/style/styles_addnew_body.tpl")
					);
		...
		case "edit":
			...
			else
			{
				...
				$template->set_filenames(array(
					"body" => "./../admin/style/styles_edit_body.tpl")
				);
				...
				{	
					...
					{	
						if( !is_file(phpbb_realpath($root_path . 'templates/' . $file)) && !is_link(phpbb_realpath($root_path . 'templates/' . $file)) && $file != "." && $file != ".." && $file != "CVS" )
						{
		...
		case "export";
			...
			{
				$template->set_filenames(array(
					"body" => "./../admin/style/styles_exporter.tpl")
				);
		...
		case "delete":
			...
			if( !$confirm )
			{
				...
				//
				$template->set_filenames(array(
					"confirm" => "./../admin/style/confirm_body.tpl")
				);
		...
		default:
			...
			$template->set_filenames(array(
				"body" => "./../admin/style/styles_list_body.tpl")
			);
