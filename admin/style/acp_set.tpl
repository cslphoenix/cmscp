...
<tr>
	<th>
		<div id="navcontainer">
			<ul id="navlist"><li id="active"><a href="#" id="current" onclick="return false;">{L_SET_HEAD}</a></li>
				<li><a href="{S_SET_FTP}">{L_SET_FTP}</a></li></ul>
		</div>
	</th>
</tr>
<tr>
...
<table class="edit" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td colspan="2"><span class="small">{L_GENERAL_SETTINGS_EXPLAIN}</span></td>
	</tr>
	...
	<tr>
		<td>{L_SCRIPT_PATH}:<br><span class="small">{L_SCRIPT_PATH_EXPLAIN}</span></td>
		<td class="row3"><input id="script_path" class="post" type="text" maxlength="255" size="25" name="script_path" value="{SCRIPT_PATH}"></td>
	</tr>
	<tr>
		<td>{L_SITE_NAME}:<br><span class="small">{L_SITE_NAME_EXPLAIN}</span></td>
	...
	<tr>
		<td>{L_DISABLE_PAGE}:<br><span class="small">{L_DISABLE_PAGE_EXPLAIN}</span></td>
	...
	<tr>
		<td>{L_DISABLE_PAGE_REASON}:</td>
		<td class="row3"><textarea class="post" cols="35" rows="4" maxlength="255" name="page_disable_msg">{DISABLE_REASON}</textarea></td>
	</tr>
	<tr>
		<td>{L_DISABLE_PAGE_MODE}:</td>
		<td class="row3">{BOARD_DISABLE_MODE}</td>
	</tr>
	<tr>
		<td>{L_EMAIL_ON-OFF}<br><span class="gensmall">{L_EMAIL_ON-OFF_EXPLAIN}</span></td>
		<td><input type="radio" name="email_enabled" value="1" {EMAIL_ON} /> {L_YES}&nbsp;&nbsp;<input type="radio" name="email_enabled" value="0" {EMAIL_OFF} />&nbsp;{L_NO}</td>
	</tr>
	</tbody>
	...
	<tr>
		<td colspan="2"><span class="small">{L_GENERAL_UPLOAD_EXPLAIN}</span></td>
	</tr>
	<tbody id="upload" style="display:none;">
	<tr>
		<td>{L_GAMES_STORAGE_PATH}:<br><span class="small">{L_GAMES_STORAGE_PATH_EXPLAIN}</span></td>
		<td class="row3"><input class="post" type="text" size="20" maxlength="50" name="game_path" value="{GAMES_PATH}" /> {GAMES_PATH_CHECKED}</td>
	</tr>
	<tr>
		<td>{L_RANKS_STORAGE_PATH}:<br><span class="small">{L_RANKS_STORAGE_PATH_EXPLAIN}</span></td>
		<td class="row3"><input class="post" type="text" size="20" maxlength="50" name="ranks_path" value="{RANKS_PATH}" /> {RANKS_PATH_CHECKED}</td>
	</tr>
	<tr>
		<td>{L_TEAM_LOGO_STORAGE_PATH}:<br><span class="small">{L_TEAM_LOGO_STORAGE_PATH_EXPLAIN}</span></td>
	...
	<tr>
		<td>{L_TEAM_LOGOS_STORAGE_PATH}:<br><span class="small">{L_TEAM_LOGOS_STORAGE_PATH_EXPLAIN}</span></td>
	...
	<tr>
		<td colspan="2"><span class="small">{L_TEAM_LOGO_SETTINGS_EXPLAIN}</span></td>
	</tr>
	<tbody id="team_logos" style="display:none;">
	<tr>
		<td>{L_TEAM_LOGO_UPLOAD}:<br><span class="small">{L_TEAM_LOGO_UPLOAD_EXPLAIN}</span></td>
	...
	<tr>
		<td>{L_TEAM_LOGO_MAX_FILESIZE}:<br><span class="small">{L_TEAM_LOGO_MAX_FILESIZE_EXPLAIN}</span></td>
		<td class="row3"><input class="post" type="text" size="4" maxlength="10" name="team_logo_filesize" value="{TEAM_LOGO_FILESIZE}" /> Bytes</td>
	</tr>
	<tr>
		<td>{L_TEAM_LOGO_MAX_SIZE}:<br><span class="small">{L_TEAM_LOGO_MAX_SIZE_EXPLAIN}</span></td>
	...
	<tr>
		<td>{L_TEAM_LOGOS_UPLOAD}:<br><span class="small">{L_TEAM_LOGOS_UPLOAD_EXPLAIN}</span></td>
	...
	<tr>
		<td colspan="2"><span class="small">{L_COOKIE_SETTINGS_EXPLAIN}</span></td>
	</tr>
	<tbody id="cookie" style="display:none;">
	<tr>
		<td>{L_COOKIE_DOMAIN}:</td>
	...
	<tr>
		<td>{L_COOKIE_SECURE}:<br><span class="small">{L_COOKIE_SECURE_EXPLAIN}</span></td>
...
<!--	
	...
	<tr>
		<td>{L_VISUAL_CONFIRM}<br><span class="small">{L_VISUAL_CONFIRM_EXPLAIN}</span></td>
	...
	<tr>
		<td>{L_ALLOW_AUTOLOGIN}<br><span class="small">{L_ALLOW_AUTOLOGIN_EXPLAIN}</span></td>
	...
	<tr>
		<td>{L_AUTOLOGIN_TIME} <br><span class="small">{L_AUTOLOGIN_TIME_EXPLAIN}</span></td>
		<td class="row3"><input class="post" type="text" size="3" maxlength="4" name="max_autologin_time" value="{AUTOLOGIN_TIME}"></td>
	</tr>
	<tr>
		<td>{L_BOARD_EMAIL_FORM}<br><span class="small">{L_BOARD_EMAIL_FORM_EXPLAIN}</span></td>
	...
	<tr>
		...
		<td class="row3"><input type="text" name="topics_per_page" size="3" maxlength="4" value="{TOPICS_PER_PAGE}"></td>
	</tr>
	<tr>
		<td>{L_POSTS_PER_PAGE}:</td>
		<td class="row3"><input type="text" name="posts_per_page" size="3" maxlength="4" value="{POSTS_PER_PAGE}"></td>
	</tr>
	<tr>
		<td>{L_HOT_THRESHOLD}:</td>
		<td class="row3"><input type="text" name="hot_threshold" size="3" maxlength="4" value="{HOT_TOPIC}"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>{L_OVERRIDE_STYLE}<br><span class="small">{L_OVERRIDE_STYLE_EXPLAIN}</span></td>
	...
	<tr>
		<td>{L_DATE_FORMAT}<br><span class="small">{L_DATE_FORMAT_EXPLAIN}</span></td>
		<td class="row3"><input type="text" name="default_dateformat" value="{DEFAULT_DATEFORMAT}"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>{L_DISABLE_PRIVATE_MESSAGING}:</td>
	...
	<tr>
		...
		<td class="row3"><input type="text" name="max_poll_options" size="4" maxlength="4" value="{MAX_POLL_OPTIONS}"></td>
	</tr>
	<tr>
		<td>{L_ALLOW_HTML}:</td>
	...
	<tr>
		<td>{L_ALLOWED_TAGS}<br><span class="small">{L_ALLOWED_TAGS_EXPLAIN}</span></td>
	...
	<tr>
		<td>{L_SMILIES_PATH} <br><span class="small">{L_SMILIES_PATH_EXPLAIN}</span></td>
	...
	<tr>
		<td>{L_MAX_SIG_LENGTH}<br><span class="small">{L_MAX_SIG_LENGTH_EXPLAIN}</span></td>
	...
	<tr>
		<td>{L_EMAIL_SIG}<br><span class="small">{L_EMAIL_SIG_EXPLAIN}</span></td>
		<td class="row3"><textarea name="board_email_sig" row_classs="5" cols="30">{EMAIL_SIG}</textarea></td>
	</tr>
	<tr>
		<td>{L_USE_SMTP}<br><span class="small">{L_USE_SMTP_EXPLAIN}</span></td>
	...
	<tr>
		<td>{L_SMTP_SERVER}:</td>
		<td class="row3"><input type="text" name="smtp_host" value="{SMTP_HOST}" size="25" maxlength="50"></td>
	</tr>
	<tr>
		<td>{L_SMTP_USERNAME}<br><span class="small">{L_SMTP_USERNAME_EXPLAIN}</span></td>
		<td class="row3"><input type="text" name="smtp_user_name" value="{SMTP_USERNAME}" size="25" maxlength="255"></td>
	</tr>
	<tr>
		<td>{L_SMTP_PASSWORD}<br><span class="small">{L_SMTP_PASSWORD_EXPLAIN}</span></td>
		<td class="row3"><input class="post" type="password" name="smtp_password" value="{SMTP_PASSWORD}" size="25" maxlength="255"></td>
	</tr>
-->
	<tr>
		<td class="catBottom" colspan="2" align="center">{S_FIELDS}<input type="submit" name="submit" value="{L_SUBMIT}" class="button2">&nbsp;&nbsp;<input type="reset" value="{L_RESET}" />
		</td>
	</tr>
</table></form>
	...
	<th>
		<div id="navcontainer">
			<ul id="navlist">
				...
				<li id="active"><a href="#" id="current" onclick="return false;">{L_SET_FTP}</a></li></ul>
		</div>
	</th>
</tr>
<tr>
	<td>{L_SET_FTP_EXPLAIN}</td>
</tr>
</table>
...
<tr>
	<td>{L_SCRIPT_PATH}path:</td>
	<td class="row3">{S_PATH_PAGE}</td>
</tr>
<tr>
	<td>{L_SITE_NAME}user:</td>
...
<tr>
	<td class="catBottom" colspan="2" align="center"><input type="submit" name="submit" value="{L_SUBMIT}" class="button2">&nbsp;&nbsp;<input type="reset" value="{L_RESET}" />
	</td>
</tr>
</table>
{S_FIELDS}
