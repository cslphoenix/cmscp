...
<tr>
	<th>
		<div id="navcontainer">
			<ul id="navlist">
				<li id="active"><a href="#" id="current">{L_SET_HEAD}</a></li>
				<li><a href="{S_SET_FTP}">{L_SET_FTP}</a></li>
			</ul>
		</div>
	</th>
</tr>
...
<!--	
	...
	<tr>
		...
		<td class="row3"><input type="text" class="post" name="smtp_user_name" value="{SMTP_USERNAME}" size="25" maxlength="255"></td>
	</tr>
	<tr>
...
<tr>
	<td class="row2">{L_SET_FTP_EXPLAIN}</td>
</tr>
</table>
...
<tr>
	<td class="row1">{L_SCRIPT_PATH}path:</td>
