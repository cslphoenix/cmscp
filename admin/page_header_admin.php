...
$template->assign_vars(array(
	...
	'L_ENTRY_NO'	=> $lang['common_entry_empty'],
...
while ( list($cat, $action_array) = each($module) )
{
	...
	$template->assign_block_vars('_cat_row', array('L_NAME' => $cat));
	...
	{
		$mod = sprintf($lang['sprintf_select_format'], ( !empty($lang[$action]) ) ? $lang[$action] : preg_replace("/_/", " ", $action));
		
		$template->assign_block_vars('_cat_row._mod_row', array(
			'L_MODULE'	=> $mod,
