...
$min_size		= 12;		// Mindestschriftgroesse
$max_size		= 16;		// Maximale Schriftgroesse

$min_angle	 	= -10;		// Neigung der Schrift in Grad
$max_angle 		= 25;		// Maximale Neigung der Schrift in Grad. 45 empfohlen.
	
$dist_head  	= 2;		// Mindestabstand des Zeichens nach oben
$dist_bottom	= 2;		// Mindestabstand des Zeichens nach unten
