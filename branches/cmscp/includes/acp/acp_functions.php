...
function get_data($mode, $id, $type)
{
	...
	switch ( $mode )
	{
		...
		case NEWS_CATEGORY:		$idfield = 'news_category_id';		break;
		...
		case STYLE:				$idfield = 'user_id';				break;
		...
		default:	message(GENERAL_ERROR, 'Error Data Mode', '', __LINE__, __FILE__);		break;
	}
...
function orders($mode, $type = '')
{
	...
	$sql = "SELECT $idfield, $orderfield FROM $table";
