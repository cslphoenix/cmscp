...
define('AUTH_GUEST',		1);//	Gäste
define('AUTH_USER',			2);//	Benutzer
define('AUTH_UPLOAD',		3);//	Uploader
define('AUTH_TRIAL',		4);//	Trialmember
define('AUTH_MEMBER',		5);//	Member
define('AUTH_COLEADER',		6);//	Squadleader
define('AUTH_LEADER',		7);//	Leader
