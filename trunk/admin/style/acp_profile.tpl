...
<tr>
	...
	<td class="row2">
		<!-- BEGIN _cat -->
		<label><input type="radio" name="profile_cat" value="{_input._cat.CAT_ID}" onclick="setRequest('profile', '{_input._cat.CAT_ID}')" {_input._cat.S_MARK} />&nbsp;{_input._cat.CAT_NAME}</label><br />
		<!-- END _cat -->
	</td>
</tr>
<tr> 
