			...
			case 'update':
				...
				$vars = array(
					'type' => array(
						...
						'type_sort'		=> array('validate' => INT,	'explain' => false, 'type' => 'radio:types),
	);
...
return $module;
				...
				{
					$data_sql = build_request(SERVER_TYPE, $vars, 'type', $error);
