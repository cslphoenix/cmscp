...
function image_check_type(&$type)
{
	...
	switch ( $type )
	{
		...
		default:
			message_die(GENERAL_ERROR, $type . $lang['image_filetype_wrong'], '', __LINE__, __FILE__);
		break;
	}
...
function image_upload($image_mode, $image_path, $image_filename, $image_realname, $image_filesize, $image_filetype)
{
