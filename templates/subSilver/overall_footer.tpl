...
<tr>
	<td style="background-image:url(templates/subSilver/images/page_/democms1.2_28.png); padding: 2px 3px;" align="left"><span class="small">{LOGGED_IN_USER_LIST}</span></td>
</tr>
<tr>
	<td>
		...
		<tr>
			...
			<td style="background-image:url(templates/subSilver/images/page_/democms1.2_29.png); height:125px; width:233px; padding: 5px;">
				...
				<tr>
					<td><input type="text" name="mail"  maxlength="100" size="25" value="email@adresse" onblur="this.className='post';if(this.value=='')this.value='email@adresse'" onfocus="this.className='post';if(this.value=='email@adresse') this.value='';" />  <input type="submit" name="submit" class="button3" value=""></td>
				</tr>
				<tr>
...
<tr>
	<td style="background-image:url(templates/subSilver/images/page_/democms1.2_34.png); background-repeat:repeat; padding: 2px 3px;" align="left"><span class="small">{GROUPS_LEGENED}</span></td>
</tr>
<tr>
	<td>
