			...
			<tr>
				<td><table width="100" border="0" cellspacing="0" cellpadding="5">
					...
					<tr align="center" valign="middle"> 
						<!-- BEGIN smilies_col -->
						<td><a href="javascript:emoticon('{smiliesrow.smilies_col.SMILEY_CODE}')"><img src="{smiliesrow.smilies_col.SMILEY_IMG}" border="0" alt="{smiliesrow.smilies_col.SMILEY_DESC}" title="{smiliesrow.smilies_col.SMILEY_DESC}" /></a></td>
						<!-- END smilies_col -->
					</tr>
					<!-- END smilies_row -->
